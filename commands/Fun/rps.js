...
exports.run = (client, message, args) => {
    let validPicks = ["rock", "paper", "scissors", "Rock", "Paper", "Scissors"];
    ...
    if (userPick == "Rock" && botPicked == "paper") return message.channel.send(`You picked \`rock\` and I picked \`${botPicked}\`. You beat me! <a:sad:737129705685123124> `);
    if (userPick == "Rock" && botPicked == "scissors") return message.channel.send(`You picked \`rock\` and I picked \`${botPicked}\`. I beat you! <a:yay:737073686871277620>`);
    //Paper
